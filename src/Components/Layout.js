...
const navigation = [
  ...
  { name: "Playlist", href: "#", icon: FolderIcon, current: false },
  { name: "Subscriptions", href: "#", icon: CalendarIcon, current: false },
  { name: "Devices", href: "#", icon: InboxIcon, current: false },
...
const Layout = () => {
  ...
  return (
    <>
      <div className="overflow-y-auto scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-blue-600/50">
                ...
                <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                  <div className="flex-shrink-0 flex items-center px-4">
                    <img
                      ...
                      src="https://uploads-ssl.webflow.com/60d587746fd9b73fa84f0665/60d6da7b9b981f813d9b1dd4_Group%201505.svg"
                      alt="Calm Sleep"
                    />
                  </div>
        ...
        <div className="hidden md:flex md:w-56 md:flex-col md:fixed md:inset-y-0">
          ...
          <div className="flex-1 flex flex-col min-h-0 bg-gradient-to-b	from-[#090b72] to-[#5b4aff] shadow-2xl">
              ...
              <nav className="mt-5 flex-1 px-2 space-y-1">
                {navigation.map((item) => (
                  <a
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? "bg-indigo-500/50 text-white" : "text-gray-300 hover:bg-indigo-800 hover:text-white",
            ...
            <div className="flex-shrink-0 flex bg-gradient-to-r	from-[#1d0e46]/75 to-[#090b72]/75 p-4">
        ...
        <div className="min-h-[100vh] md:pl-64 flex flex-col flex-1 bg-gradient-to-b from-[#090b72] to-[#5b4aff]">
          ...
          <main className="flex-1">
            <div className="py-6">{component === "dashboard" || component === undefined || component === null ? <Content /> : <Page404 />}</div>
          </main>
        </div>
      </div>
    </>
